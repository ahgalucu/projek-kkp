...
@section('container')
    ...
    <div class="table-responsive">
        @foreach ($evaluasis as $evaluasi)
            <a class="btn btn-success mb-3 me-3" href="/dashboard/posts/evaluasi" role="button">Kembali</a>

            <a href="/dashboard/posts/evaluasi/{{ $evaluasi->id }}/edit" class="btn btn-warning mb-3 me-3" role="button">
                Ubah
            </a>
